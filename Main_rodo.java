...
public class Main_rodo {
	...
	// viagem
		...
		System.out.println(pas1.getCodigo());
		...
		System.out.println(vi1.getPassagens());
		...
		// comprar passagem
		Passagem pas2 = rod2.comprarPassagem(1, 10); // comprar passagem viagem 2 assento 10
